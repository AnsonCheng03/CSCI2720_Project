...
const canvasRef = useRef<HTMLCanvasElement>(null);
    ...
    class Effect {
        constructor(context, cvWidth, cvHeight){
        ...
        wrapText(text){
            ...
            linesArray.forEach((el, i) => {
                this.context.fillText(el, this.canvasWidth / 1.95, this.canvasHeight /3);
                this.context.strokeText(el, this.canvasWidth / 1.95, this.canvasHeight /3);
            });
